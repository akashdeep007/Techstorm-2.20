...
class _FantaCState extends State<FantaC> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Navigator.push(context,new MaterialPageRoute(builder: (context) =>RegisterForm(eventName : 'FantaC',team: true, teamMembers: 2)));
      ...
      floatingActionButtonLocation: FloatingActionButtonLocation.centerFloat,
              ...
              body: Container(
                      ...
                      image : DecorationImage(
                        image : AssetImage('assets/images/BRAIN/FANTA-C.jpg'), fit:BoxFit.cover
                      )
                    ),
                child: ListView(
                  children: <Widget>[
