    ...
    child: FlipCard(
        ...
        front: Stack(fit: StackFit.expand, children: <Widget>[
          Card(
              ...
              child: Image.asset('assets/images/GAMES/NFS.jpg',
                  fit: BoxFit.cover)),
          Center(
              child: Text(
            'Need for Speed',
  ...
  Container(
    ...
    child: FlipCard(
        ...
        front: Stack(fit: StackFit.expand, children: <Widget>[
          Card(
              semanticContainer: true,
              child: Image.asset('assets/images/GAMES/KHET.jpg',
                  fit: BoxFit.cover)),
          Center(
              child: Text(
            'KHET',
  ...
  Container(
    ...
    child: FlipCard(
        ...
        front: Stack(fit: StackFit.expand, children: <Widget>[
          Card(
              semanticContainer: true,
              child: Image.asset('assets/images/GAMES/CLASH_OF_CLANS.jpg',
                  fit: BoxFit.cover)),
          Center(
              child: Text(
            'Clash of Clans',
  ...
  Container(
    ...
    child: FlipCard(
        ...
        front: Stack(fit: StackFit.expand, children: <Widget>[
          Card(
              semanticContainer: true,
              child: Image.asset('assets/images/GAMES/FIFA.jpg',
                  fit: BoxFit.cover)),
          Center(
              child: Text(
            'FIFA',
